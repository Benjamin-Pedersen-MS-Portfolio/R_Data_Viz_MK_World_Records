...
The set of data sets we used are called, “Mario Kart 64 World Records” from tidytuesday on GitHub’s website under rfordatascience. 	Concepts covered in this course were data manipulation, performing statistical analysis and creating visualizations primarily using the Tidyverse and GT libraries for the statistical software R.
